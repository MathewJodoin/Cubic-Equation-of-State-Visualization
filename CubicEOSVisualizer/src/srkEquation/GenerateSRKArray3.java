...
public class GenerateSRKArray3
{
	public static float[][] vaporComp;
	public static float[][] liquidComp;
	
	public static void GenerateSRKArray3()
	{
		...
		// The following are the pure component values of the SRK equation constants.
		...
		// Giorgio Soave, Snam Progetti, Div. Sviluppo, Milano, Italy 1971
		// Chemical Engineering Science, 1972, Vol. 27, pp. 1197-1203
		double a1 = (0.42747 * (Math.pow(r, 2) * Math.pow(SRKParamPanel.getTc1(), 2)) / SRKParamPanel.getPc1());
		double a2 = (0.42747 * (Math.pow(r, 2) * Math.pow(SRKParamPanel.getTc2(), 2)) / SRKParamPanel.getPc2());
		double a3 = (0.42747 * (Math.pow(r, 2) * Math.pow(SRKParamPanel.getTc3(), 2)) / SRKParamPanel.getPc3());
		
		double b1 = (0.8664 * (r * SRKParamPanel.getTc1())/SRKParamPanel.getPc1());
		double b2 = (0.8664 * (r * SRKParamPanel.getTc2())/SRKParamPanel.getPc2());
		double b3 = (0.8664 * (r * SRKParamPanel.getTc3())/SRKParamPanel.getPc3());
		...
		double m1 = (0.48508 + 1.55171 * SRKParamPanel.getW1() + 0.15613*Math.pow(SRKParamPanel.getW1(), 2));
		double m2 = (0.48508 + 1.55171 * SRKParamPanel.getW2() + 0.15613*Math.pow(SRKParamPanel.getW2(), 2));
		double m3 = (0.48508 + 1.55171 * SRKParamPanel.getW3() + 0.15613*Math.pow(SRKParamPanel.getW2(), 2));
		...
		for(int i = 0; i < numRow; ++i)
		{
			for(int j = 0; j < numRow; ++j)
			{
					x3 = 1 - x1CompArray[i] - x2CompArray[j];
						...
						cubicSolver.solve(1, -1, A-B-Math.pow(B, 2), -A*B);
